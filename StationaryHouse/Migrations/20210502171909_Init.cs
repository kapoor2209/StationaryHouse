...
namespace StationaryHouse.Migrations
{
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StationeryID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StationeryName = table.Column<string>(maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stationeries_SubCategories_SubCategoryID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Stationeries_StationeryID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_StationeryID",
                table: "Orders",
                column: "StationeryID");

            migrationBuilder.CreateIndex(
                name: "IX_Stationeries_SubCategoryID",
                table: "Stationeries",
